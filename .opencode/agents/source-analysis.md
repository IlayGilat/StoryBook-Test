---
description: "Perform a strictly read-only analysis of the legacy benchmark root and its complete rendered tree, discovering nodes top-down and classifying every dependency for deterministic downstream planning."
mode: primary
---
