---
description: "Create and verify the repository's standard eleven-file benchmark scaffold for one top-level target by invoking the built-in generator exactly once, without implementing or adapting generated contents."
mode: primary
---
