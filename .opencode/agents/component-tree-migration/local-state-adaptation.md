---
description: "Preserve rendering-relevant local presentation state and interactions without promoting them unnecessarily to application or benchmark state."
mode: subagent
---
