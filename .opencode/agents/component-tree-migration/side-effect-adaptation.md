---
description: "Convert assigned non-presentational side effects into explicit typed intents while retaining presentation-only feedback and interaction sequencing."
mode: subagent
---
