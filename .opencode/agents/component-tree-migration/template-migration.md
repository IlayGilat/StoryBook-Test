---
description: "Copy and minimally adapt the assigned node's Angular template while preserving its rendered DOM, semantics, accessibility, classes, bindings, and child composition."
mode: subagent
---
