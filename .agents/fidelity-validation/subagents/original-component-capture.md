...
Write only beneath `.migrations/<component>/validation/fidelity/legacy/`. Never edit legacy files, component code, shared reports, decisions, `state.json`, or handoffs.
